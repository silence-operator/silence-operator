...
const (
	SilenceKind      = "Silence"
	SilenceFinalizer = "monitoring.coreos.com/Silence"
)
...
type SilenceStatus struct {
	...
	AlertManagerID        string `json:"alertmanager_id,omitempty"`
	LastAppliedGeneration int64  `json:"last_applied_generation,omitempty"`
}
